...
##### 📌 Featured Projects<br>- 🚀 AI CRM System (LLM + LangGraph based intelligent CRM) <br>- 🩸 Blood Group Identification (Django + OpenCV) <br>- 📊 Campaign Analytics Dashboard (React + Spring Boot) <br><br>---
